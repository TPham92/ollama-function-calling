...
const cityToLatLonTool = new Tool(
  ...
  [
    new ToolParameter(
      "city",
      "The city to get the latitude and longitude for",
      "string",
      true
    ),
  ]
...
const webSearchTool = new Tool("WebSearch", "Search the web for a query", [
...
const makeDrinkTool = new Tool("makeDrink", "Get the ingredients for a drink", [
  new ToolParameter(
    "ingredient",
    'The ingredient to get the drink for. For example, {"ingredient": "whiskey", quantity: 1, unit: "oz"}',
    "object",
    true
  ),
]);
